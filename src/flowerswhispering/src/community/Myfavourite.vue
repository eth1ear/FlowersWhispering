<template>
       ...
       <div class="side-bar">
              <div class="user-info">
                  ...
                  <div class="tabs">              <!--显示选项卡-->
                    ...
                    <button :class="{ active: activeTab === 'Myfavourite' }" @click="setActiveTab('Myfavourite')">我的收藏</button>
    ...
    <div v-if="showModal" class="modal-overlay" @click="closeModal">
      <div class="modal-content" @click.stop>
        ...
        <button class="modal-delete-button" @click="deletePost">解除收藏</button>
